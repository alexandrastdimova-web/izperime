      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <div className="text-lg md:text-xl text-muted-foreground leading-relaxed space-y-4 text-left">
            <p>
              Ние сме малка семейна фирма от Велико Търново, създадена през 2023 година. Предлагаме професионално пране на дивани, матраци, мека мебел и автомобилни салони с внимание към всеки детайл.
            </p>
            <p>
